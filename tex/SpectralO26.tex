...
$\delta_{\mathrm{pair}}$ stability holds.
  ...
  \subsection{Level III: Conditional theorem}
    ...
    \begin{remark}
      ...
      (O29~\cite{Beau2026a33}); the spin-$\tfrac{1}{2}$ sector itself is selected
  ...
  (spin-$1$) carrier $H_{\mathrm{eff}}$ rather than the spin-$\tfrac{1}{2}$ target.
    ...
    \begin{remark}[Carrier identification by Test~4 --- O29]
      ...
      It does not identify the spin-$\tfrac{1}{2}$ sector $V_\rho$, which is not reachable
  ...
  \subsection{Outlook}
    ...
    computation.
    Of the three open questions formulated at the time of writing, two are settled:
    the effective dimension $r_{\mathrm{eff}} = 3$ is established universally
    across all conjugate pairs at $q \in \{61, 101, 151\}$ (O28~\cite{Beau2026a32}),
    ...
    (spin-$1$) carrier $H_{\mathrm{eff}} \simeq \mathfrak{su}(2)$.
