  ...
  \subsection{Decision table}
    ...
    \begin{center}
      \begin{tabular}{p{0.52\textwidth}|p{0.40\textwidth}}
        ...
        Tests~1--3 pass, $r^{\Phi}_{\mathrm{eff}}$ fixed, Test~5 fails & Level~II; Level~III not supported \\
        Tests~1--5 pass, $r^{\Phi}_{\mathrm{eff}}$ fixed & Consistent with Level~III; under condition~(a) the
    ...
    \begin{remark}
      ...
      The tested conjugate-pair samples do not reach rank four, and the locking-broken control recovers four
      operator directions only in an auxiliary PCA truncation.
