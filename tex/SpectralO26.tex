...
\date{April 2026\\[2pt]\small Version 1.4.3}
...
\begin{document}
  ...
  \begin{abstract}
    ...
    canonical Hermitian quadratic form and provide a representation-theoretic
    interpretation of the pair observable itself.
...
$\delta_{\mathrm{pair}}$ stability holds.
  ...
  \subsection{Boundary of the $\beta^*$ interpretation}
    ...
    constrains the admissible representation sector, but that sector identification does
