...
\begin{document}
  ...
  \begin{abstract}
    ...
    sector (a structurally motivated hypothesis; O18~\cite{Beau2026a22} states the
  ...
  O18~\cite{Beau2026a22} establishes Born--Infeld parity as an equivariant symmetry
...
$\delta_{\mathrm{pair}}$ stability holds.
  ...
  \subsection{Level III: Conditional theorem}
    ...
    \begin{remark}
      ...
      Hypothesis~\ref{hyp:embedding} is resolved in O27~\cite{Beau2026a31},
      conditionally on the supplied spinor carrier of O23:
      the quaternionic rigidity theorem therein shows that
  ...
  \subsection{Role of non-injectivity}
    ...
    (O18~\cite{Beau2026a22} establishes Born--Infeld parity as an equivariant
    symmetry and states the fibre identification as an open problem).
