...
$\delta_{\mathrm{pair}}$ stability holds.
  ...
  rather than $\mathrm{End}(V_\rho)$, so no measured rank is a value of the $\mathrm{End}(V_\rho)$ target
  $d_\rho^2 = 4$, and the modal value
  ...
  \subsection{Outlook}
    ...
    \begin{remark}[Test~4 in O29]
      ...
      seed-sensitive single-sample exceptions above it, and no measured rank is a value of the
      $\mathrm{End}(V_\rho)$ target $d_\rho^2 = 4$; the numerical $6 \to 3$
