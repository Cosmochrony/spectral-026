...
$\delta_{\mathrm{pair}}$ stability holds.
  ...
  \subsection{Test 4: Effective dimension of the trajectory}
    ...
    \begin{criterion}[Effective dimension]
  ...
  \subsection{Decision table}
    ...
    \begin{center}
      \begin{tabular}{l|l}
        ...
        Tests~1--4 pass ($r_{\mathrm{eff}} = 4$), Test~5 fails & Level~II with spin-$\tfrac{1}{2}$ sector \\
  ...
  \subsection{Outlook}
    ...
    computation.
    A positive result at Level~III would provide the first representation-theoretic
    realisation of the admissible cascade exponent.
    A negative result with a fixed effective dimension $r_{\mathrm{eff}} \neq 4$
    would identify the correct ambient sector, refining the admissibility hierarchy
    without invalidating the dictionary.
