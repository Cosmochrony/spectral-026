  ...
  \subsection{Decision table}
    ...
    \begin{center}
      \begin{tabular}{l|l}
        ...
        \hline
        Tests~1--3 fail & Dictionary construction fails; §\ref{sec:dictionary} must be revised \\
        ...
        Tests~1--5 pass & Level~III; Hypothesis~\ref{hyp:embedding} supported; Theorem~\ref{thm:level3} applies \\
        \hline
      \end{tabular}
    \end{center}
