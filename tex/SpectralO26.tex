...
$\delta_{\mathrm{pair}}$ stability holds.
  ...
  \subsection{Level III: Conditional theorem}
    ...
    \begin{remark}
      ...
      Among the conditions of Hypothesis~\ref{hyp:embedding}, naturality~(c) is
      the only one for which no explicit algebraic construction is currently available.
      Test~4 of §\ref{sec:tests} provides direct numerical evidence for~(c).
    \end{remark}
